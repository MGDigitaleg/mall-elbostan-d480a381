...
const faqs = [
  { q: "متى موعد الافتتاح الكبير؟", a: "يوم 1 مايو 2026 — ستُعلن ساعات الافتتاح الرسمية مع اقتراب الموعد." },
  { q: "كيف أشارك في مسابقة أدر واربح؟", a: "ادخل صفحة أدر واربح، سجّل ببياناتك، وأدر العجلة. كل رقم هاتف يحصل على فرصة واحدة." },
  { q: "هل يمكنني استلام الجائزة بدون حضور يوم الافتتاح؟", a: "لا — يجب الحضور شخصيًا يوم الافتتاح وإبراز شاشة الفوز لاستلام الجائزة." },
  { q: "أين يقع مول البستان؟", a: "القاهرة الجديدة — بالقرب من مدينتي والرحاب. يمكنك زيارة صفحة الفرع لمعرفة الموقع الدقيق." },
  { q: "هل يوجد مواقف سيارات؟", a: "نعم، يتوفر جراج متعدد الطوابق مع سعة كبيرة لاستيعاب الزوار." },
  { q: "كيف أتواصل مع إدارة المول؟", a: "من خلال صفحة تواصل معنا أو عبر واتساب المتاح في أسفل الموقع." },
];
