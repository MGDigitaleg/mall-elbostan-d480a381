...
const faqs = [
  { q: "متى موعد الافتتاح؟", a: "يوم ١٥ مايو ٢٠٢٦ — ساعات العمل الرسمية ستُعلن مع اقتراب الموعد." },
  { q: "كيف أشارك في أدر واربح؟", a: "ادخل صفحة أدر واربح، سجّل ببياناتك، وأدر العجلة. كل رقم هاتف له فرصة واحدة." },
  { q: "هل يمكن استلام الجائزة بدون حضور؟", a: "لا — يجب الحضور شخصياً يوم الافتتاح وإبراز شاشة الفوز للاستلام." },
