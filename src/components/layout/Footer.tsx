...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden min-h-[480px] md:min-h-[520px]" style={{ background: "linear-gradient(180deg, #060E1C 0%, #071326 40%, #0A0F1A 100%)", contain: "layout style" }}>
