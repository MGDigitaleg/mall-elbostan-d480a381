...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden min-h-[750px] sm:min-h-[640px] md:min-h-[640px] lg:min-h-[560px]" style={{ background: "linear-gradient(180deg, #060E1C 0%, #071326 40%, #0A0F1A 100%)", contain: "layout style" }}>
