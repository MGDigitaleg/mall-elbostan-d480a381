...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden min-h-[750px] sm:min-h-[640px] md:min-h-[640px] lg:min-h-[560px]" style={{ background: "linear-gradient(180deg, #060E1C 0%, #071326 40%, #0A0F1A 100%)", overflowAnchor: "none", contain: "layout style" }}>
        ...
        <div className="grid gap-5 lg:grid-cols-[1.5fr_1fr_1fr_1fr] lg:gap-8 lg:gap-y-10 xl:gap-12">
          ...
          <div className="space-y-3 lg:space-y-5">
            <Link to="/" className="inline-block">
              <img src={logoWhite} alt="مول البستان" width={120} height={70} className="h-[70px] w-auto object-contain opacity-90 transition-opacity hover:opacity-100" loading="lazy" decoding="async" />
            </Link>
