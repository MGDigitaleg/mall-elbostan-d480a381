...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden" style={{ background: "linear-gradient(180deg, #060E1C 0%, #071326 40%, #0A0F1A 100%)", overflowAnchor: "none", contain: "layout style paint" }}>
