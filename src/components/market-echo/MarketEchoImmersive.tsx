...
function SceneOpening() {
  ...
  return (
    ...
    >
      ...
      >
        <p>ما كان الناس يرددونه قديماً، لم يكن مجرد كلام عابر.</p>
        <p className="mt-1">كان اسماً ارتبط بالمقارنة والثقة ومعرفة المكان الصحيح.</p>
      </div>
  ...
  return (
    <section ref={ref} className="relative overflow-hidden echo-scene-spacing" style={{ minHeight: isMobile ? "75svh" : "92svh" }}>
      ...
      <div className="echo-container relative z-10 pt-20 md:pt-28">
        ...
        >
          هذه العبارات لم تكن أمثالاً فقط، بل اختصاراً لتجربة شراء مفهومة في مكان معروف.
        </p>
      </div>
    ...
    >
      <div className="echo-container">
        <div className="mx-auto max-w-[760px] text-center">
          ...
          >
            ما كان الناس يقولونه قديماً، نقدمه اليوم بشكل أوضح.
          </h2>
...
const timelineStops = [
  ...
  { year: "",     title: "بداية الانتشار",      desc: "أصبح الاسم مرجعاً أساسياً لكل من يبحث عن أجهزة الكمبيوتر وقطع الغيار في مصر." },
  { year: "",     title: "عصر الإنترنت",        desc: "مع تغير السوق، ظل البستان حاضراً في المقارنة والسؤال وبناء الثقة." },
