...
const quotes = [
  ...
  },
  {
    ...
    explanation: "لأن المقارنة بين المحلات كانت دائماً خطوة أساسية قبل اتخاذ القرار.",
  },
  {
      ...
      <div className="container relative z-10 max-w-5xl">
        ...
        >
          ...
          >
            ...
            مكان معروف في عالم التقنية. لم تكن هذه الجمل مجرد كلام عابر، بل انعكاساً لثقة حقيقية
            وحضور واضح في السوق.
          </p>
        </motion.div>
        ...
        >
          <p className="text-[0.82rem] leading-[1.85]" style={{ color: "#94A3B8" }}>
            ما كان الناس يرددونه قديماً، يتحول اليوم إلى تجربة أوضح عبر دليل المحلات، والخريطة
