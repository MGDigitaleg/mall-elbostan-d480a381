  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        {/* Ambient glows */}
        <div
          className="absolute top-[12%] left-[8%] h-[650px] w-[650px] rounded-full opacity-[0.04]"
          style={{ background: "radial-gradient(circle, #2563EB, transparent 70%)" }}
        />
        <div
          className="absolute bottom-[8%] right-[6%] h-[550px] w-[550px] rounded-full opacity-[0.03]"
          style={{ background: "radial-gradient(circle, #CDBB9A, transparent 70%)" }}
        />
        <div
          className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 h-[800px] w-[800px] rounded-full opacity-[0.018]"
