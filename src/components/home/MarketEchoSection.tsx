...
const quoteCards = [
  ...
  },
  {
    ...
    meaning: "قبل أي قرار شراء، كان التعارف يبدأ بجولة في البستان. المقارنة بين المحلات والأسعار والتشكيلات كانت طقساً ثابتاً لكل مشتري ذكي.",
  },
  {
  ...
  },
  {
    ...
    meaning: "اسم أصبح مقياساً للسعر العادل في السوق. حين يقول أحدهم: سعر البستان كام؟ فهو يسأل عن المعيار الذي يقيس عليه بقية الأسعار.",
  },
];
          ...
          <div className="mx-auto max-w-4xl lg:grid lg:grid-cols-[1fr_1.1fr] lg:gap-16 lg:items-center">
            ...
            >
              ...
              >
                ...
                لم يكن مجرد اسم لمبنى، بل اسماً يعرفه من يبحث عن الخيارات المناسبة في عالم التقنية.
              </motion.p>
            ...
            >
              ...
              <motion.p
                ...
                style={{ color: "#64748B" }}
              >
                ما كان الناس يرددونه قديماً، نترجمه اليوم إلى تجربة أسهل وأوضح داخل الموقع.
              </motion.p>
