  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
      <div className="grid grid-cols-1 md:grid-cols-[1.3fr_0.7fr]">
        {/* Map preview */}
        <div className="relative border-b border-border bg-muted/30 md:border-b-0 md:border-l" style={{ overflow: "hidden" }}>
          <div className="relative w-full" style={{ paddingBottom: "75%", minHeight: "260px" }}>
        ...
        <div className="flex flex-col justify-between gap-4 px-5 py-5 md:px-6 md:py-6">
          <div className="space-y-1.5">
            ...
            <p className="max-w-[20rem] text-[0.8rem] leading-relaxed text-muted-foreground">
              تصفّح الخريطة واعرف حالة كل وحدة مباشرة.
            </p>
          </div>
