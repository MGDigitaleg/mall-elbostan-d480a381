...
export function MapTeaserPreview() {
  ...
  return (
    <div className="section-shell rounded-[1.7rem] p-3 md:p-4">
      <div className="grid gap-3 xl:grid-cols-[1.18fr_0.82fr] xl:items-start">
        <div className="space-y-3">
          ...
          <FloorPlanSvg
            className="min-h-[21rem] rounded-[1.45rem] border border-border/80 p-3 md:min-h-[23rem] md:p-4 lg:min-h-[26rem] lg:p-4"
        ...
        <div className="space-y-3">
          <div className="editorial-panel rounded-[1.45rem] p-4 md:p-5">
            <p className="text-xs font-semibold text-muted-foreground">الوحدة المحددة</p>
            <h3 className="mt-2 text-2xl font-bold text-foreground">وحدة {activeUnit.unit_id}</h3>
