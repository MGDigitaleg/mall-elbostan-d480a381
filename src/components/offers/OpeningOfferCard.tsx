...
export function OpeningOfferCard({ offer, cardId, compact = false, showStoreLink = true, showAllStoreOffersCta = false, directOfferHref, directOfferLabel = "انتقل إلى العرض" }: Props) {
  ...
  const titleClass = c ? "text-[0.78rem] leading-snug" : "text-[0.95rem] leading-snug";
  const descClass = c ? "line-clamp-2 text-[0.68rem] leading-5 mt-1.5" : "line-clamp-3 text-[0.76rem] leading-7 mt-2";
