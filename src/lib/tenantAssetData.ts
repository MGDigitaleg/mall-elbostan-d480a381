...
export const tenantBrands: TenantBrand[] = [
  {
    ...
    matchedAsset: "/logos/tenants/static.webp",
  ...
  },
  {
    ...
    normalizedName: "شرف",
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/sharaf.webp",
    executionNote: "Logo extracted from composite source.",
    exportSlug: "Sharaf",
  },
  {
  ...
  },
  {
    ...
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/go-plus.webp",
    executionNote: "Logo extracted from composite source.",
    exportSlug: "Go-Plus",
  },
  {
  ...
  },
  {
    ...
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/al-sahaba.webp",
    executionNote: "Logo extracted from composite source.",
  ...
  },
  {
    ...
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/red-line.webp",
    executionNote: "Logo extracted from composite source.",
    exportSlug: "Red-Line",
  },
  {
  ...
  },
  {
    ...
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/print-show.webp",
    executionNote: "Logo extracted from composite source.",
  ...
  },
  {
    ...
    normalizedName: "HK",
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/hk.webp",
    executionNote: "Logo extracted from composite source.",
    exportSlug: "HK",
  },
  {
    ...
    normalizedName: "WiFi",
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/wifi.webp",
    executionNote: "Logo extracted from composite source.",
    exportSlug: "WiFi",
  },
  {
  ...
  },
  {
    ...
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/express-home.webp",
  ...
  },
  {
    ...
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/spark.webp",
    executionNote: "Logo extracted from composite source.",
    exportSlug: "Spark",
  },
  {
    ...
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/games-to-egypt.webp",
    executionNote: "Logo extracted from composite source.",
  ...
  },
  {
    ...
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/info-max.webp",
    executionNote: "Logo extracted from composite source.",
    exportSlug: "Info-Max",
  },
  {
  ...
  },
  {
    ...
    normalizedName: "i7",
    logoStatus: "Confirmed",
    matchedAsset: "/logos/tenants/i7.webp",
    executionNote: "Logo extracted from composite source.",
    exportSlug: "i7",
  },
  {
