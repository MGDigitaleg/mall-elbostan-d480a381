      ...
      <div className="container py-20">
        ...
        {!isExpired ? (
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4">العروض تبدأ يوم الافتتاح!</h2>
            <p className="text-muted-foreground max-w-lg mx-auto mb-8">ترقب عروضاً حصرية وخصومات مذهلة على أحدث المنتجات التقنية بدءاً من يوم الافتتاح.</p>
            <CountdownTimer />
          </div>
        ) : isLoading ? (
          <LoadingGrid />
