      ...
      <div className="container py-20">
        ...
        {!isExpired ? (
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto mb-8">ترقّب عروضاً حصرية وخصومات من متاجر المول على أحدث المنتجات التقنية — بدءاً من يوم الافتتاح.</p>
            <CountdownTimer />
          </div>
        ) : isLoading ? (
          <LoadingGrid />
          ...
          <EmptyState title="لا توجد عروض نشطة حالياً" description="تابعنا لمعرفة آخر العروض والخصومات من متاجر المول." />
        )}
      </div>
    </MainLayout>
  );
